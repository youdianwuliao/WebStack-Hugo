...
数据源：/tmp/shanhaijing_data.json
  由 /tmp/clean_shj.py 从维基文库（zh.wikisource.org）逐页抓取《山海经》主条目的
  治本正文整理而成——十九页：〈郭璞序〉＋〈山经〉五篇（南山经…中山经）＋
  〈海经〉十三篇（海外四经、海内四经、大荒四经、海内经），繁体原文，
  含郭璞注（南山经、西山经、海内经东经三篇有注，余篇维基文库未录注）。
  抓取时须 `--resolve zh.wikisource.org:443:208.80.153.224`（本机默认 DNS 指向不通节点）。
